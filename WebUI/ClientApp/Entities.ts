...
class DetailsAndTaxabl {
    constructor() { 
        this.IQ_Sls_InvoiceDetail_Tax = new Array<IQ_Sls_InvoiceDetail_Tax>();
        this.taxableItem = new Array<TaxableItem>();

    } 
    public IQ_Sls_InvoiceDetail_Tax: Array<IQ_Sls_InvoiceDetail_Tax>;
    public taxableItem: Array<TaxableItem>;
}
...
class IQ_Sls_InvoiceDetail_Tax {
    constructor() {
        this.InvoiceID = 0;
        this.InvoiceItemID = 0;
        this.ItemID = 0;
...
class IQ_InvoiceHedar_Tax {
    ...
    public VersionInv: string;
    public GlobalInvoiceCounter: number;
    public receiverID_rec: number;
    public branchID_rec: number;
    public country_rec: string;
    public governate_rec: string;
    public regionCity_rec: string;
    public street_rec: string;
    public buildingNumber_rec: string;
    public postalCode_rec: string;
    public floor_rec: string;
    public room_rec: string;
    public landmark_rec: string;
    public additionalInformation_rec: string;
    public type_rec: string;
    public id_rec: string;
    public name_rec: string;
    public issuerID_iss: number;
    public branchID_iss: number;
    public country_iss: string;
    public governate_iss: string;
    public regionCity_iss: string;
    public street_iss: string;
    public buildingNumber_iss: string;
    public postalCode_iss: string;
    public floor_iss: string;
    public room_iss: string;
    public landmark_iss: string;
    public additionalInformation_iss: string;
    public type_iss: string;
    public id_iss: string;
    public name_iss: string;
    public CurrencyCode: string;
    public DescA: string;
    public DescL: string;
    public Remarks: string;
